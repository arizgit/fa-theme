...
import { animate, timeline as timeline2, stagger } from "//freakathlete.co/cdn/shop/t/62/assets/vendor.min.js?v=114992621884149252901715014964";
...
import { stagger as stagger2 } from "//freakathlete.co/cdn/shop/t/62/assets/vendor.min.js?v=114992621884149252901715014964";
...
import { animate as animate2, stagger as stagger3, inView } from "//freakathlete.co/cdn/shop/t/62/assets/vendor.min.js?v=114992621884149252901715014964";
...
import { inView as inView2 } from "//freakathlete.co/cdn/shop/t/62/assets/vendor.min.js?v=114992621884149252901715014964";
...
import { timeline as timeline3, inView as inView3 } from "//freakathlete.co/cdn/shop/t/62/assets/vendor.min.js?v=114992621884149252901715014964";
...
import { animate as animate3 } from "//freakathlete.co/cdn/shop/t/62/assets/vendor.min.js?v=114992621884149252901715014964";
...
import { animate as animate4 } from "//freakathlete.co/cdn/shop/t/62/assets/vendor.min.js?v=114992621884149252901715014964";

// js/common/overlay/dialog-element.js
import { FocusTrap, Delegate } from "//freakathlete.co/cdn/shop/t/62/assets/vendor.min.js?v=114992621884149252901715014964";
...
import { animate as motionAnimate, timeline as motionTimeline } from "//freakathlete.co/cdn/shop/t/62/assets/vendor.min.js?v=114992621884149252901715014964";
...
var Drawer = class extends DialogElement {
  ...
  _getClipPathProperties() {
    const is_modal = this.template === 'modal';
    const rounded = is_modal ? '--rounded' : '--rounded-sm';
  ...
  _hideTransition() {
    ...
    // code for drawer video stop on close
     var drawers = document.getElementsByTagName('x-drawer');
    Array.from(drawers).forEach(drawer => {
        var videos = drawer.getElementsByTagName('video');
...
import { animate as motionAnimate2, timeline as motionTimeline2 } from "//freakathlete.co/cdn/shop/t/62/assets/vendor.min.js?v=114992621884149252901715014964";
...
import { Delegate as Delegate2 } from "//freakathlete.co/cdn/shop/t/62/assets/vendor.min.js?v=114992621884149252901715014964";
...
import { animate as animate5 } from "//freakathlete.co/cdn/shop/t/62/assets/vendor.min.js?v=114992621884149252901715014964";
...
import { animate as animate6, timeline as timeline4, stagger as stagger4 } from "//freakathlete.co/cdn/shop/t/62/assets/vendor.min.js?v=114992621884149252901715014964";
...
import { Delegate as Delegate3 } from "//freakathlete.co/cdn/shop/t/62/assets/vendor.min.js?v=114992621884149252901715014964";
...
import { PhotoSwipeLightbox } from "//freakathlete.co/cdn/shop/t/62/assets/vendor.min.js?v=114992621884149252901715014964";
var ProductGallery = class extends HTMLElement {
  ...
  connectedCallback() {
    ...
    this._prevButton = this.querySelector('[is="prev-button"]');
    this._nextButton = this.querySelector('[is="next-button"]');
    ...
    if (this._prevButton && this._nextButton) {
      this._prevButton.addEventListener("click", () => {
        this._carousels[0].dispatchEvent(new CustomEvent("control:prev", { bubbles: true, cancelable: true }))
      });
      this._nextButton.addEventListener("click", () => {
        this._carousels[0].dispatchEvent(new CustomEvent("control:next", { bubbles: true, cancelable: true }))
      });
    }
  }
  disconnectedCallback() {
  ...
  get photoswipe() {
    ...
    const photoswipe = new PhotoSwipeLightbox({
      pswpModule: () => import("//freakathlete.co/cdn/shop/t/62/assets/photoswipe.min.js?v=20290624223189769891715014964"),
      bgOpacity: 1,
...
import { animate as animate7, timeline as timeline5 } from "//freakathlete.co/cdn/shop/t/62/assets/vendor.min.js?v=114992621884149252901715014964";
...
import { inView as inView4 } from "//freakathlete.co/cdn/shop/t/62/assets/vendor.min.js?v=114992621884149252901715014964";
...
var VideoMedia = class extends BaseMedia {
  connectedCallback() {
    super.connectedCallback();
    this.playClipAction = Promise.resolve();
    ...
    if (this.hasAttribute("show-play-button") && !this.shadowRoot) {
      this.attachShadow({ mode: "open" }).appendChild(document.createRange().createContextualFragment(`
        ...
        <svg part="play-button" fill="none" width="48" height="48" viewBox="0 0 48 48">
          <path d="M48 24C48 10.745 37.255 0 24 0S0 10.745 0 24s10.745 24 24 24 24-10.745 24-24Z" fill="#11171b"/>
  ...
  async playClip(start = 0, stop = 1) {
    if (this.hasAttribute("host")) {
      console.error('Shopify hosted video media only!');
      return;
    }

    const video = this._playerTarget();
    const action = () => new Promise((resolve) => {
      video.pause(); // kill any previous backgournd videos - force exit
      video.currentTime = start;
      const checkStop = () => {
        let force_exit = false;
        let is_finished = false;
        if (video.paused) {
          // if the video was paused outside of this listener, then we
          // need to exit and let the animations know to stop
          is_finished = true;
          force_exit = true;
        }
      ...
      video.play().then(_ => video.addEventListener("timeupdate", checkStop));
    });
    this.playClipAction = this.playClipAction.then(action);
    return this.playClipAction;
  }
  _playerTarget() {
    if (this.hasAttribute("host")) {
      this.setAttribute("loaded", "");
...
import { timeline as timeline6 } from "//freakathlete.co/cdn/shop/t/62/assets/vendor.min.js?v=114992621884149252901715014964";
...
import { animate as animate8 } from "//freakathlete.co/cdn/shop/t/62/assets/vendor.min.js?v=114992621884149252901715014964";
...
import { animate as animate9 } from "//freakathlete.co/cdn/shop/t/62/assets/vendor.min.js?v=114992621884149252901715014964";
...
import { animate as animate10, inView as inView5 } from "//freakathlete.co/cdn/shop/t/62/assets/vendor.min.js?v=114992621884149252901715014964";
...
// js/theme.js
import { Delegate as Delegate4 } from "//freakathlete.co/cdn/shop/t/62/assets/vendor.min.js?v=114992621884149252901715014964";
(() => {
...
/*document.addEventListener("DOMContentLoaded", function() {
    const nsWraps = document.querySelectorAll('.fa-ns-wrap');
    const dropdowns = document.querySelectorAll('.freakathlete__dropdown');

    if (nsWraps.length === dropdowns.length) {
        nsWraps.forEach((nsWrap, index) => {
            nsWrap.addEventListener('click', function(event) {
                event.stopPropagation(); 
                nsWrap.classList.toggle('active');
